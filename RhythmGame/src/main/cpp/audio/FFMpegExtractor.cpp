...
bool FFMpegExtractor::createAVIOContext(AAsset *asset, uint8_t *buffer, uint32_t bufferSize, AVIOContext **avioContext) {
...
int64_t FFMpegExtractor::decode(AAsset *asset, uint8_t *targetData, AudioProperties targetProperties) {
